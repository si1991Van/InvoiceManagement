...
<div class="row">
	<div class="col-xs-12">
        ...
        <!-- form start -->
        {{ Form::open(array('action' => array('CustomerController@update', $data->id), 'method' => 'PUT')) }}
          <div class="box-body">
            ...
            <div class="form-group">
              <label>Nhóm khách hàng</label>
               <div class="row">
                    <div class="col-sm-6">
                        {{ Form::select('group_id', GroupCustomer::lists('name', 'id'), $data->group, array('class' => 'form-control')) }}
                    </div>
               </div>
            </div>
            <div class="form-group">
